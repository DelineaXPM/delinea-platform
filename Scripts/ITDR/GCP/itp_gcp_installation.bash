...
export SERVICE_ACCOUNT_NAME=<SERVICE ACCOUNT> 
export CREATE_KEY=false 
...
create_service_account() { 
    ...
    ROLES=("roles/cloudasset.viewer" "roles/storage.objectAdmin" "roles/logging.viewer" "roles/serviceusage.serviceUsageAdmin") # Add more roles as needed 
