# Databricks Secret Server Discovery
...
This scanner will perform the Discovery of Databricks Users and categorize them as Admin, service or Local accounts  .
...
- This completes the creation of the tenant Scan Template Creation
