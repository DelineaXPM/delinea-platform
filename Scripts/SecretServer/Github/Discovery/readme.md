...
This scanner can help perform an Scan for user accounts within a Github Organization. Account types will be distinguished by the appropriate roles qne Teams designated by Github and Integrations Key Secret.
...
- Navigate to **ADMIN** > **Discovery** > **Configuration** > 
    ...
    - Fill out the required fields with the information
        ...
        - Click Save
        - This completes the creation of the GitHub Account Scanner
...
### Next Steps
 ...
 The GitHub Discovery configuration is now complete.  The next step is to run a manual discovery scan.
