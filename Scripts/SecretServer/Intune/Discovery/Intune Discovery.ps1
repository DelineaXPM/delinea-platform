...
$userlist = @()
    ...
    # Pagination
    while($users.'@odata.nextLink'){$nexturi = $users.'@odata.nextLink'
...
#region get Admin Accounts
    ...
    function get-AdminAccounts{
        try {   
            ...
            # Pagination
              while($adminMembership.'@odata.nextLink'){$nexturi = $adminMembership.'@odata.nextLink'
...
function get-SvcAccounts{
    try {   
        ...
        # Perform a search for each group ID and add matching users to an array
            ...
            # Pagination
              while($svcAcctslist.'@odata.nextLink'){$nexturi = $svcAcctslist.'@odata.nextLink'
