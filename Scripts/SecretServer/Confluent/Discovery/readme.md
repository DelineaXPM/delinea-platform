...
- Fill out the required fields with the information from the application registration
  ...
  - Script: Copy and paste the Script included in the file [Confluent Discovery](./Confluent%20Discovery.ps1)
...
- Find the Confluent Local Account Scanner or the Scanner created in the [Create Confluent Account Scanner Section](#create-Confluent-account-scanner) and Click **Add Scanner**
