# Confluent Remote Password changer
...
- Fill out the required fields 
    ...
    - **Script**: Copy and paste the Script included in the file [Confluent Remote Password Changer.ps1](./Confluent%20RPC%20Placeholder.ps1)
    - Click Save
...
- Fill out the required fields 
    ...
    - **Category**: Heartbeat
    - **Merge Fields**: Leave Blank
    - **Script**: Copy and paste the Script included in the file [Confluent Heartbeat.ps1](./Confluent%20Heartbeat%20Placeholder.ps1)
    - Click Save
...
- Click Edit
- Click the **Scan Template to use** (Dropdown List) Select the Confluent User template created in the [Instructions.md Document](../Instructions.md)
