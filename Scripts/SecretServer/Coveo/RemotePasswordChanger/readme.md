# Coveo Remote Password changer

The steps below show how to Set up and configure a Coveo Remote Password Changer.
...
- Enter a Name (Example - Coveo Remote Password Changer )
- Click Save
...
## Update Coveo User template

- Log in to Secret Server Tenant (if not already logged in)
- Navigate to **ADMIN** > **Secret Templates**
- Find and Select the Coveo User Template created in the [Instructions.md Document](../Instructions.md)
