# Expected Argd args=@( "Coveo Tenenant Base URL", "Coveo OrgID",  "API Key","API KeyId","[AdminGroup]=[AdminGroupId]{,[AdditionalGroup]=[AdditionalGroupID]}","[ServiceGroup]=[ServiceGroupId]{,[AdditionalGroup]=[AdditionalGroupID]}"  )
