...
- Fill out the required fields 
    ...
    - **Script**: Copy and paste the Script included in the file [Docusign Remote Password Changer.ps1](./Docusign%20RPC%20Placeholder.ps1)
    - Click Save
...
- Fill out the required fields 
    ...
    - **Category**: Heartbeat
    - **Merge Fields**: Leave Blank
    - **Script**: Copy and paste the Script included in the file [Docusign Heartbeat.ps1](./Docusign%20Heartbeat%20Placeholder.ps1)
    - Click Save
...
- Find and Select the Docusign User Template created in the [Instructions.md Document](../Instructions.md)
...
- Click Edit
- Click the **Scan Template to use** (Dropdown List) Select the Docusign User template created in the [Instructions.md Document](../Instructions.md)
